...
window.MYERS_DATA = {
  PHASES: [
    ...
    },
    {
      ...
      description: 'Set up your CRM and contract platforms so you can start working deals immediately.',
      tasks: [
    ...
    },
    {
      ...
      description: 'Set up your email, safety tools, team communication, and shared resources so you never miss a beat.',
      tasks: [
        ...
        { id: 'calendars', title: 'Calendars', desc: 'Subscribe to the Myers DFW Showings Calendar to stay updated on all property showings.', icon: 'calendar', accent: '#2E5C8A' },
      ],
    },
    {
      id: 'brand',
